...
API_ID = int(environ.get("API_ID", "25842496"))
API_HASH = environ.get("API_HASH", "456e7efe6107765e7752a2bfb6754ea6")
BOT_TOKEN = environ.get("BOT_TOKEN", "7715958458:AAEdFna80SDMYejDLP2cH6sRtgKbLgSzTlA")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "922875836").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Drjain72"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "#Drjain72")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002682162944").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "0"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002049582775"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002692734602"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "0"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "0"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Povieed1:Povieed1@povieed1.gnbjdug.mongodb.net/?retryWrites=true&w=majority&appName=Povieed1")
DATABASE_NAME = environ.get("DATABASE_NAME", "Povieed1")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://Povieed2:Povieed2@povieed2.47xqn52.mongodb.net/?retryWrites=true&w=majority&appName=Povieed2")
...
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+_qlT9I6rsJMwMzM1")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+ExvwpZUJ2bk5N2M1")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://i.ibb.co/M5pFMX2C/c0f170f6091e.jpg",
    )
).split()
...
# Other Funtions
FILE_AUTO_DEL_TIMER = int(environ.get("FILE_AUTO_DEL_TIMER", "18000"))
...
DELETE_TIME = int(environ.get("DELETE_TIME", False))
